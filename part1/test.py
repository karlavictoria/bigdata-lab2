...
for i in range(n_iter):
    ...
    centroid1 = [shotclock,shotdist,closedef]
    ...
    centroid2 = [shotclock,shotdist,closedef]
    ...
    centroid3 = [shotclock,shotdist,closedef]
    ...
    centroid4 = [shotclock,shotdist,closedef]
...
#adding a column with the greatest hitrate to the previous table
...
#ussing the besthitrate column to determine the best zone for each player
...
df11 = sqlcontext.sql("""SELECT playername, besthitrate, bestzone
                    FROM df
